...
void Block::RenderCubeBlock(Block block, glm::ivec3 coord, std::array<bool, 6> faces, Geometry *geometry)
{
...
void Block::RenderFlowerBlock(Block block, glm::ivec3 coord, Geometry *geometry)
{
    unsigned int &offset = geometry->Offset;
    std::array<unsigned char, 6> blockTextures = Blocks::GetTextures(block.ID);
    int x = coord.x;
...
void Block::RenderTorchBlock(Block block, glm::ivec3 coord, Geometry *geometry)
{
    unsigned int &offset = geometry->Offset;
    std::array<unsigned char, 6> blockTextures = Blocks::GetTextures(block.ID);
    int x = coord.x;
    ...
    geometry->Indices.insert(
        geometry->Indices.end(), {0 + offset, 1 + offset, 2 + offset, 2 + offset, 3 + offset, 0 + offset, 4 + offset, 5 + offset, 6 + offset, 6 + offset, 7 + offset, 4 + offset, 8 + offset,
                                     9 + offset, 10 + offset, 10 + offset, 11 + offset, 8 + offset, 12 + offset, 13 + offset, 14 + offset, 14 + offset, 15 + offset, 12 + offset, 16 + offset,
                                     17 + offset, 18 + offset, 18 + offset, 19 + offset, 16 + offset, 20 + offset, 21 + offset, 22 + offset, 22 + offset, 23 + offset, 20 + offset});
...
void Block::RenderSlabBlock(Block block, glm::ivec3 coord, std::array<bool, 6> faces, Geometry *geometry)
{
    unsigned int &offset = geometry->Offset;
    std::array<unsigned char, 6> blockTextures = Blocks::GetTextures(block.ID);
...
void Block::RenderWaterBlock(Block block, glm::ivec3 coord, std::array<bool, 6> faces, Geometry *geometry)
{
    unsigned int &offset = geometry->Offset;
    std::array<unsigned char, 6> blockTextures = Blocks::GetTextures(block.ID);
